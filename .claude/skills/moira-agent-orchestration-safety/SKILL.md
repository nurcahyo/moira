...
Read and follow `../../../.agents/skills/moira-agent-orchestration-safety/SKILL.md` completely. That canonical workflow is shared by Codex and Antigravity and is authoritative for this repository.
