...
once answered they move to [`../docs/decisions-taken.md`](../docs/decisions-taken.md) with their
evidence and reversal condition. Deferred hardening lives in [`../TODO.md`](../TODO.md).
