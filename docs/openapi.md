...
User-visible success notices and typed errors use the i18n response contract documented in [docs/i18n-response-contract.md](i18n-response-contract.md). The generated examples and catalog keep `message_key` stable while exposing an English fallback `message` for curl, Postman, and operator tooling.
